...
function ReturningLoop({ data, isConnectable,list ,selected }) {
  ...
  return (
    <div className={` hover:scale-[1.025] duration-150 w-32 flex flex-col p-2 shadow-lg rounded-md bg-[#fffe] backdrop-blur-sm border `}>
        ...
        <label htmlFor="condition" className='text-sm text-[#333] flex items-center gap-1'>return loop </label>
{
  !list&&
  <>
