...
function SetVar({ data , isConnectable ,list}) {
  ...
  return (
    <div className="  hover:scale-[1.025] duration-150  p-2 shadow-lg rounded-md flex bg-[#00356650] backdrop-blur-sm border border-[#fff5]">
        ...
        <Handle className='bg-[#3a86ff] border-[#3a86ff] rounded-lg h-4' type="source" id="value" position={Position.Right} isConnectable={isConnectable} />
        ...
        <p className='text-[#3a86ff] pr-2'>set</p>
        ...
        <p className='text-[#3a86ff] pl-2'>to</p>
    </div>
  );
}
