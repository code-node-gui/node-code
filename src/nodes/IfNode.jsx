...
function IfNode({ data, isConnectable }) {
  ...
  return (
    <div className="w-32 flex flex-col p-2 shadow-lg rounded-md bg-[#00356650] backdrop-blur-sm border border-[#fff5]">
    <Handle className='bg-[#ffc300] border-[#ffc300] rounded-lg h-4' type="target" id="source" position={Position.Left} isConnectable={isConnectable} />
